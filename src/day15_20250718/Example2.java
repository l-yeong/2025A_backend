...
interface Buy {
    ...
    //+디폴트메소드:인터페이스타입에서 구현한 메소드
    public default void method1(){}

    //+정적메소드: 인터페이스타입에서 정적 구현 메소드
    public static void method2(){}

    //+Private 메소드: 현제 인터페이스타입 에서만 사용 가능한 구현 메소드
...
class Customer extends Object implements Buy, Sell {
    ...
    // implements: 클래스 1개당 구현은 여러개의 인터페이스 가능, 포괄적인 다형성
...
public class Example2 {
    public static void main(String[] args) {
        ...
        //[5] private 메소드 ?? 구현체에서 구현 하지 않을때
        // 즉] 오버라이딩(재정의/구현)금지

        //[6] private 정적 메소드
        // 즉] 타입 내부적으로 사용되는 정적 메소드
