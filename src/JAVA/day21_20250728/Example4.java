    ...
    public static void main(String[] args) {
        /*
         [ 스레드 풀 ]
            ...
            2. 목적: 작업이 들어올때 마다 새로운 스레드가 아닌 기존 스레드 이용
            3. 효과: 스레드 재사용, 자원 효율성, 과부하 방지 등등
            4. 구조: 작업의 요청을 '큐' 라는 자료구조로 배치하여 순서대로 스레드풀에서 대기중인 스레드 에게 작업 배정
                * 큐? 자료의 데이터들을 요청 순서대로 처리 방법, 먼저 들어온 요청이 먼저 처리 된다.
                ----------------------------------
                input [요청3] [요청2] [요청1] output
                ----------------------------------
            5. 생활속예시: 콜센터, 유재석이 콜센터에 전화 하면 대기중인 직원1(스레드) 존재 하면 처리 아니면 대기
                                    스레드풀
                                        직원1(스레드)
            콜요청 ----------->          직원2(스레드)
                                        직원3(스레드)
            6. 사용처: 1)톰켓[자바웹클래스]    2)JDBC  3)업로드/다운로드  4)채팅
            7. 사용법
        */
