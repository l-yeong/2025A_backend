...
public class Example1 {
    public static void main(String[] args) {
        /*
        [ 상속 ]
            1. 정의: (상위)클래스 로부터 (하위)클래스 에게 (멤버) 물려주는 행위
            ...
            7. 예]
            8. 다형성: 다양한 형식/타입을 갖는 성질
                1) 자동(묵시적)타입변환
                    (1) 기본타입 (8가지)
                        byte -> short -> int -> long -> float -> double
                    (2) 참조타입
                        하위 클래스(타입)에서 상위 클래스 (타입)으로 변환
                        가능 조건] extends 상하/부모/계층 관계 일때만 가능하다.
            ...
            ***컴퓨터가 이해하는 다형성 이란?***
                (닭)객체 생상되면 [눈에 안보임] 조류 객체 --> 동물 객체 생성
        ...
        */
        ...
        //[2] 조류 클래스로 객체 1개
        조류 bird = new 조류();
        // --> extentds 란? 상위클래스의 멤버변수/메소드를 하위클래스가 사용
        ...
        // (3) 동물(객체)와 클래스를 참새로 변경
            // --> 상위 클래스는 하위클래스를 모른다.
            // 왜? 하위클래스가 상위클래스를 선택 하는 구조
