...
public class Example2 {
    public static void main(String[] args) {
        ...
        */
        ...
        //활용] 임의 여러개 데이터 중 하나 선택 하기
        ArrayList<String> nameList = new ArrayList<>();
        nameList.add("유재석"); nameList.add("신동엽"); nameList.add("탁재훈");
        int randomIndex=random.nextInt(nameList.size()); // .size() : arraylist 길이 반환 메소드
        System.out.println("당첨: " + nameList.get(randomIndex));
        ...
        System.out.println("생성코드:"+code);

        // 활용3] 아스키코드 패턴으로 난수 계사식 못만들 경우 직접 난수에 넣을 데이터 배열로 선언
        ...
        System.out.println("생성된비밀번호:"+newPwd);

        // 활용4] 주사위: 1~6 사이
        int ran = random.nextInt(6)+1;
        System.out.println(ran);

        //활용5] 로또 번호 생성: 1~45 사이의 중복 없이 6자리 생성
        ...
        //    } // if end
        //    lottoList.add(lotto); // 생성된 로도 번호를 리스트에 담기
        //}//for end
        ...
        System.out.println("자동 로또번호:"+lottoList);
