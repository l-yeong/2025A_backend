    ...
    public static void main(String[] args) {
        ...
        [ String 클래스 ]: 자바에서 문자열 표현하는 방법
            ...
            2. 문자열 비교하는 방법
                ...
                2) 문자열A.equals(문자열B)  : "리터럴" 과 객체문자열을 비교 가능.
            3. 주요 메소드
        ...
        */
        ...
        // 1. 배열을 이용한 문자열 표현
        char str1 ='유'; // ' '작은따옴표 감싼 문자 1개는 char타입
        char[] str = {'유','재','석'}; //''작은따옴표 3개를 char 배열 타입
        ...
        //5. 주요 메소드
        //1) .concat : 문자열 연결 메소드 vs 문자열A+문자열B
        ...
        System.out.println(builder); //메모리 효율이 좋다
        ...
        sql3 += "insert into ";
        sql3 += "table(name) ";
        sql3 += "values("+name+")"; //비권장: 주의할점은 띄어쓰기 주의
        ...
        String str13 ="012345-1230123".substring(0,6); //0번 인덱스부터 6번인덱스 전 까지
        System.out.println(str13);
        String str14 ="012345-1230123".substring(7); // 7번인덱스 부터( 마지막인덱스까지) 추출
        System.out.println(str14);
        // 활용] 차량번호 조회: 214가7531, 차량번호 뒷자리 : 차량번호.subString(차량번호.length()-1-3)

        //9) .split("구분문자"); : 지정한 문자열내 구분문자 기준으로 잘라서 배열로 반환 메소드
        String[] str15 = "012345-1230123".split("-"); //'-' 기즌으로 문자열 쪼개기
