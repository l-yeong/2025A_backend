...
class Dto <T,E>{
    T value1;   // T : 정해지지 않는 타입
    E value2;   // E : 정해지지 않는 타입
}
...
public class Example3 {
    public static void main(String[] args) {
        ...
        [ 제네릭 타입 ]
            ...
            2. 목적: 클래스 정의할때 변수 타입을 정하지 않고 인스턴스 생성할때 변수 타입 정한다.
            ...
            3. 사용법: < >  꺽은괄호 이용한 표현
                ...
                2) 인스턴스 생성
                    ...
                    클래스명<타입명A,타입명B> 변수명 = new생성자명<>();

           4. 활용처: 컬렉션프레임워크(실무중요)
                -> ArrayList<제네릭타입> : ArrayList 객체, 객체내 여러개 요소들을 저장할 항목타입 == 제네릭타입
           5. 특징: 변수명 타입 유연성, 코드중복제거, 잘못된타입방지
