...
public class Example1 {
    public static void main(String[] args) {
        ...
        - 타입: 값 분류하는 종류
            1. 기본타입:8가지, 리터럴 자료, 소문자로시작, int,
                    int a=3;        -- 3자료를 int로 분류
                    double a=3;     -- 3자료를 double로 분류
                vs
            2. 참조타입: 배열/클래스/인터페이스, new(인스턴스)자료, 대문자로시작, Integer
                    -> 개발자 만든 타입 또는 라이브러리
                    MemberDto a = new MemberDto() <-- (인스턴스)자료

        [클래스]: 기본타입에 존재하지 않는 새로운 타입 설계, 라이브러리(도구) 미리 만들어진 클래스들
            예] int는 정수 1개만 저장 타입 하므로, int int 정수 2개 저장하는 타입
        ...
        [ 자바의 기본 클래스 ]
           ...
           3. Wrapper 클래스: 8가지 기본타입을 참조타입 사용
                특징: 기본타입은 메소드(기능)이 없어서 다양한 기능 제공 받는다.
           ...
           4. LocalDate 클래스: 시스템의 날짜/시간 정보 클래스
                ...
                주요메소드
                    1. LocalDateTime.now()                 : 시스템의 현재 날짜/시간 를 갖는 LocalDateTime 객체 반환
                    2. LocalDateTime.of(년,월,일,시,분,초)   : 지정한 값으로 날짜/시간를 갖는 LocalDateTime 객체 반환
                    ...
                    9. .format(DateTimeFormatter); : 지정한 형식으로 날짜/시간 문자열로 반환
        ...
        */
        ...
        Object o1 =3;                     // 정수를 Object로 분류 할수 있다.
        Object o2 =3.14;                  // 실수를 Object로 분류 할수 있다.
        Object o3 =true;                  // 논리를 Object로 분류 할수 있다.
        Object o4 ="유재석";               // 문자열을 Object로 분류 할수 있다.
        ...
        System.out.println(o7); // day20.BookDto@7cca494b

            // 2. equals(): == 변수가 갖는 주소값 비교, equals(): 주소가 갖는 객체 비교
        Object o9 = new BookDto();
        System.out.println(o9);                 // JAVA.day20_20250725.BookDto@6d311334
        Object o10 = new BookDto();
        System.out.println(o10);                //JAVA.day20_20250725.BookDto@682a0b20
        Object o11=o9;                          //o9는 o11에 대입한다.
        ...
        System.out.println(str1.equals(str2));  //true
            // 3.hashCode(): 객체의 주소(객체가 위치한 메모리 위치)을 정수로 반환
        ...
        //2.
        // .getFields();       : 클래스/타입 의 모든 클래스의 멤버변수명 반환
        // .getConstructors(); : 클래스/타입 의 모든 생성자명 반환
        // .getMethods();      : 클래스/타입 의 모듬 메소드명 반환
        ...
        System.out.println(localtime); // 11:36:31.542850800
        LocalDateTime localDateTime = LocalDateTime.now();
        System.out.println(localDateTime); //2025-07-25T11:37:25.473613700
        //2. 지정한 날짜/시간 생성 of(년,월,일,시,분,초)
        LocalDateTime localDateTime1= LocalDateTime.of(2025,07,25,11,38,15);
        System.out.println(localDateTime1);

        //3. 날짜/시간 형식 변경
            // 패턴: y연도,M(대문자)월,d일,h시,m(소문자)분,s초
        ...
        int dat= localDateTime.getDayOfMonth();//일
        ...
        System.out.println(plusDateTime); //2025-08-04T11:50:17.620898
        LocalDateTime minusDateTime = localDateTime.minusDays(30);
        System.out.println(minusDateTime); //2025-06-25T11:50:17.620898
