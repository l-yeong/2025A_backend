...
class 상위클래스{
    ...
    상위클래스(){System.out.println("[상위클래스 인스턴스생성]");}
    //메소드
    void showValue(){System.out.println(">>상위클래스의 메소드 실험<<");}
}
...
class 하위클래스 extends 상위클래스{
    ...
    //메소드
    void showValue2(){System.out.println(">>하위클래스 메소드 실행<<");}
    //메소드2
    void showValue(){System.out.println(">> 하위클래스의 메소드 실행 <<");}
}
...
public class Example1 {
    ...
    obj2.showValue(); //현재타입
    obj2.showValue2(); //상위타입 접근가능

    //(3)멤버변수명이 동일할때 구분 : 멤버변수 객체 마다 할당
        //상위클래스의 멤버변수
        System.out.println(obj2.value1); //10
        //현재클래스의 멤버변수
        System.out.println(obj2.value3); //30
        // 만일 상위타입/하위타입내 동일한 멤버변수 일때 현재 타입 우선
    ...
    //(4) 메소드명이 동일할때 구분: 오버라이딩
        ...
        obj2.showValue(); //obj2(하위타입) 일때 메소드실행
        상위클래스 obj4=obj2;
