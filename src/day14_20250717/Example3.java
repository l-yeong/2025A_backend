...
public class Example3 {
    public static void main(String[] args) {
        ...
        /*
            ...
            [ 인터페이스 ]
                ...
                2. 생활속 예]
                    ...
                    TV 리모콘: 삼성TV, LG TV 등 서로 다른 회사/모델의 TV들을 하나의 리모콘 조작
                    키오스크: 국밥키오스크, 아이스크림 키오스크 등 서로 다른 업체들을 하나의 키오스크로 조작
                ...
                5. 선언하는 방법
                    ...
                    2) 하위에(인터페이스) 선택 -> 인터페이스명 정하기(첫글자를 대문자로)
                    - interface 인터페이스명{ }
                6. 인터페이스 타입의 멤버
                    1) 상수
                    2) 추상메소드
        ...
        */
        ...
        //[7] 추상메소드 불러오기, 추상메소드는 구현{}이 없으면 사용 불가능
...
//클래스 선언부: 클래스명 implements 인터페이스명{}
//지정한 인터페이스의 추상메소드를 구현하기 전 까지 오류 발생
class Tool implements TestInterface{
    // -- (1) 추상메소드 구현하기:
    // 추상메소드와 선언부 동일하게 실행문{} 자유롭게
    public void method2(){
