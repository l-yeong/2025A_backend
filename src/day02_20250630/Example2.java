...
public class Example2 {
    public static void main(String[] args) {
        ...
        1. new Scanner(System.in); 시스템(컴퓨터)로부터 입력 관련 기능(함수) 제공하는 객체
                *Scanner scan = new Scanner(System.in);

        2. 종류
                (1) .next()         : 입력 받은 문자열 (String) 반환, 단] 띄어쓰기 불가능.
                    String 변수명 = scan.next();
                (2) .nextLine()     : 입력 받은 문자열 (String) 반환, 단] 띄어쓰기 가능.
                    *주의할점: nextLine() 안에 다른 next()가 존재하면 enter(가행)를 하나로 포함 하므로 문제가 발생
                    *해결방안: nextLine() 앞에 무의미한 next() 하나 추가 한다.
