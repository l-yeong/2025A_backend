...
//        프로그래머 여부: true
        ...
        System.out.print("프로그래머 여부:");
        boolean pro=scan.nextBoolean();

        System.out.printf("이름:%s\n",name);
        System.out.printf("나이:%d\n",age);
        System.out.printf("키%3.1f\n",height);
        System.out.printf("프로그램여부:%s\n",pro);
