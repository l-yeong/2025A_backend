...
public class Example1 {
    public static void main(String[] args) {
        ...
        */
        //[1] 클래스 에서 메소드 선언
        //[2] 다른 클래스내 객체 메소드 호출하기
            //1) 호출하고자 하는 메소드를 갖는 클래스로 객체생성
        Calculator cal1=new Calculator();
            //2) 호출하고자 하는 메소드를 갖는 객체이용한 메소드 호출
        cal1.getPi(); //객체.메소드명();
        //[3] 매개변수x, 반환값O : 반환값이 있을때 주로 변수에 대입한다.
        ...
        int a=1;
        //int result3=cal.add("안녕",a);
        //오류발생: 인수값 과 매개변수의 타입이 일치 해야한다.
