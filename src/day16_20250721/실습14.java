...
//    필요 코드:
        try {
            ...
            System.out.println("[문제1]0으로 나눌수 없습니다" + e);
        }
//
...
//    필요 코드:
        try {
            ...
            System.out.println("[문제2] 잘못된 숫자 형식 입니다." + e);
        }
...
//    필요 코드:
        try {
            ...
            System.out.println("[문제3] 잘못된 인덱스에 접근했습니다." + e);
        }
//
...
//    필요 코드:
        try {
            ...
            System.out.println("[문제4] 객체가 초기화 되지 않았습니다" + e);
        }
...
//            2. finally 블록을 사용하여, 예외 발생 여부와 상관없이 항상 "데이터베이스 연결을 종료합니다."가 출력되도록 만드세요.
        try {
            String str = "[문제5] 데이터베이스 연결을 시작 합니다.";
            System.out.println(str);
        } catch (RuntimeException e) {
            System.out.println("[문제5] 잘못된 타입 입니다." + e);
        } finally {
            System.out.println("[문제5] 데이터베이스 연결을 종료 합니다.");
        }
//
//[문제 6] 다중 catch 블록
...
//    필요 코드
        try {
            ...
            System.out.println("[문제6] 객체가 초기화 되지 않았습니다. "+e1);
        }catch (ArithmeticException e2){
            System.out.println("[문제6] 0으로 나눌수 없습니다. "+e2);
        }
...
//            필요 코드
    try{
        pauseOneSecond();
        System.out.println("[문제7] 출력보이기용");
    }catch (InterruptedException e){
        System.out.println("[문제7] 일시정지"+e);
    }
...
//    필요코드
        try {
            ...
            System.out.println("[문제8] 알 수 없는 오류가 발생 했습니다"+e);
        }
